...
exports.deactivateMyAccount = exports.deleteMyTask = exports.updateMyTask = exports.getMyTask = exports.createMyTask = exports.getMyTasks = void 0;
...
exports.deactivateMyAccount = (0, catchAsync_1.default)(async (req, res) => {
    await User_1.default.findByIdAndUpdate(req.currentUser._id, {
        active: false
    }, {
        runValidators: true,
        new: true
